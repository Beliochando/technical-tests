...
export function PokeList({
  ...
  const filteredPokemon = badgeFilter
    ? pokemonWithBadges.filter((p) => p.badges[badgeFilter])
    : pokemonWithBadges;

  let displayedPokemon = filteredPokemon;
  if (sortOrder === "asc") {
    displayedPokemon = [...filteredPokemon].sort((a, b) =>
