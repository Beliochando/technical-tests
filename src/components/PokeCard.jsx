  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 right-2 flex gap-1">
        {badges?.legendary && (
          <div className="badge badge-soft badge-error flex items-center gap-1 text-xs px-0.5 py-0.5">
            <MdStars size={14} />
          </div>
        )}
        {badges?.mythical && (
          <div className="badge badge-soft badge-warning flex items-center gap-1 text-xs px-0.5 py-0.5">
            <MdShield size={14} />
          </div>
        )}
        {badges?.hasHiddenAbility && (
          <div className="badge badge-soft badge-info flex items-center gap-1 text-xs px-0.5 py-0.5">
            <GiNinjaHead size={14} />
          </div>
        )}
      </div>
